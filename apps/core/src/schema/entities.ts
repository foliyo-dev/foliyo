  ...
  entities: {
    ...
    project: {
      ...
      fields: [
        ...
        "url_label", "repo_url_label", "article_url_label",
        "skills_developed", "featured", "sort_order",
      ],
      table: "projects",
    },
    experience: {
    ...
    portfolio: {
      ...
      fields: [
        ...
        "skills_title", "projects_title", "experience_title",
        "education_title", "certifications_title", "languages_title",
      ],
      table: "portfolios",
    },
    resume: {
